...
export const EXERCICES_BASE: Exercice[] = [
  ...
  // ── PROGRAMME OTAGO (prévention des chutes) ─────────────────────────────────
  // Otago Exercise Programme (Campbell & Robertson, University of Otago) :
  // programme validé par méta-analyse, réduction du risque de chute de
  // 35-40 %, adaptation française disponible. Lot 1 (force + équilibre).
  //
  // Priorité donnée aux profils les moins couverts du catalogue avant cet
  // ajout — diabete/obesite/prothese_genou/prothese_hanche, 3 exercices
  // chacun, aucun avec texte d'adaptation — voir docs/PLAN-BETA.md.
  ...
  // FORCE — Otago
  {
    ...
    categorie: 'force',
    description: 'Assis sur une chaise, dos droit, tendre lentement un genou jusqu\'à extension complète de la jambe, maintenir un instant, puis redescendre le pied au sol sans le laisser retomber.',
    consigneSecurite: 'Chaise stable avec assise ferme. Mouvement lent et contrôlé ; ne jamais forcer au-delà d\'une amplitude confortable, surtout en cas de prothèse de genou récente.',
    niveaux: {
      debutant: '8 répétitions par jambe, sans charge',
      intermediaire: '10 répétitions par jambe, maintien 2 secondes en position haute',
      avance: '10 répétitions par jambe avec lest à la cheville (0,5 à 1 kg)',
    },
    materielNecessaire: 'Chaise stable, lest de cheville en option',
    dureeEstimeeMinutes: 5,
    profilsCompatibles: ['prothese_genou', 'diabete', 'obesite', 'tous'],
    adaptations: {
      prothese_genou: 'Respecter l\'amplitude autorisée par le chirurgien, surtout en phase post-opératoire précoce ; arrêter en cas de douleur articulaire.',
      diabete: 'Vérifier l\'état cutané des chevilles avant et après si un lest est utilisé (risque de frottement, sensibilité parfois réduite).',
      obesite: 'Le poids du membre suffit souvent comme résistance ; ne pas ajouter de lest sans nécessité.',
    },
    positionRequise: 'assis',
    niveauMobilite: 'modere',
    reference: 'Programme Otago (Campbell & Robertson, University of Otago)',
    niveau_config: {
      "1": { series: 2, repetitions: 8,  duree_secondes: null, description: 'Sans charge, amplitude confortable', conseil: 'Redescendez le pied lentement, sans le laisser tomber' },
      "2": { series: 3, repetitions: 10, duree_secondes: null, description: 'Maintien 2 secondes en position haute', conseil: 'Gardez la pointe du pied relevée vers vous pendant le mouvement' },
      "3": { series: 3, repetitions: 10, duree_secondes: null, description: 'Avec lest de cheville 0,5-1 kg', conseil: 'N\'ajoutez le lest que si le mouvement reste indolore' },
    },
  },
  {
    id: 'ot-genou-flex',
    ...
    categorie: 'force',
    description: 'Debout derrière une chaise, mains en appui léger sur le dossier, plier un genou en amenant le talon vers les fesses, puis redescendre lentement le pied au sol.',
    consigneSecurite: 'Chaise stable, idéalement contre un mur. Garder le buste droit sans se pencher en avant ; ne pas forcer la flexion en cas de douleur ou de raideur du genou.',
    niveaux: {
      debutant: '8 répétitions par jambe, amplitude réduite',
      intermediaire: '10 répétitions par jambe, talon proche des fesses',
      avance: '12 répétitions par jambe avec lest à la cheville léger',
    },
    materielNecessaire: 'Chaise stable, lest de cheville en option',
    dureeEstimeeMinutes: 5,
    profilsCompatibles: ['prothese_genou', 'diabete', 'obesite', 'tous'],
    adaptations: {
      prothese_genou: 'Limiter l\'amplitude de flexion à ce qui est autorisé par le chirurgien ; progresser prudemment sur les premières semaines post-opératoires.',
      diabete: 'Porter des chaussures fermées pendant l\'exercice pour protéger les pieds à l\'appui.',
      obesite: 'Privilégier un appui bilatéral stable sur la chaise avant toute tentative à un seul appui.',
    },
    positionRequise: 'debout',
    niveauMobilite: 'complet',
    reference: 'Programme Otago (Campbell & Robertson, University of Otago)',
    niveau_config: {
      "1": { series: 2, repetitions: 8,  duree_secondes: null, description: 'Amplitude réduite, appui bilatéral sur la chaise', conseil: 'Ne montez le talon que jusqu\'où c\'est confortable' },
      "2": { series: 3, repetitions: 10, duree_secondes: null, description: 'Amplitude complète, talon proche des fesses', conseil: 'Gardez les hanches alignées, sans balancer le bassin' },
      "3": { series: 3, repetitions: 12, duree_secondes: null, description: 'Avec lest de cheville léger', conseil: 'Contrôlez la descente, ne laissez pas le pied retomber' },
    },
  },
  {
    id: 'ot-hanche-abd',
    nom: 'Abduction de la hanche debout',
    categorie: 'force',
    description: 'Debout derrière une chaise, mains en appui léger, lever une jambe tendue sur le côté sans incliner le tronc, puis reposer lentement.',
    consigneSecurite: 'Chaise stable. Garder le buste bien droit et face à la chaise ; un tronc qui s\'incline signifie que l\'amplitude demandée est trop grande.',
    niveaux: {
      debutant: '8 répétitions par jambe, amplitude faible',
      intermediaire: '10 répétitions par jambe, amplitude complète sans incliner le tronc',
      avance: '12 répétitions par jambe avec lest à la cheville léger',
    },
    materielNecessaire: 'Chaise stable, lest de cheville en option',
    dureeEstimeeMinutes: 5,
    profilsCompatibles: ['prothese_hanche', 'diabete', 'obesite', 'tous'],
    adaptations: {
      prothese_hanche: 'Ne pas dépasser l\'amplitude autorisée par le chirurgien ; éviter tout croisement de la jambe au-delà de l\'axe du corps, en particulier en post-opératoire précoce.',
      diabete: 'Surveiller l\'équilibre en fin de série, la fatigue musculaire peut apparaître progressivement.',
      obesite: 'Réduire l\'amplitude si nécessaire pour garder le tronc stable plutôt que de forcer le mouvement.',
    },
    positionRequise: 'debout',
    niveauMobilite: 'complet',
    reference: 'Programme Otago (Campbell & Robertson, University of Otago)',
    niveau_config: {
      "1": { series: 2, repetitions: 8,  duree_secondes: null, description: 'Amplitude faible, appui bilatéral', conseil: 'Le tronc ne doit pas bouger pendant le mouvement' },
      "2": { series: 3, repetitions: 10, duree_secondes: null, description: 'Amplitude complète sans incliner le tronc', conseil: 'Levez la jambe sur le côté, jamais vers l\'avant' },
      "3": { series: 3, repetitions: 12, duree_secondes: null, description: 'Avec lest de cheville léger', conseil: 'Ralentissez si le tronc commence à osciller' },
    },
  },
  {
    id: 'ot-hanche-ext',
    nom: 'Extension de la hanche debout',
    categorie: 'force',
    description: 'Debout derrière une chaise, mains en appui léger, tendre une jambe vers l\'arrière sans cambrer le bas du dos, puis reposer lentement.',
    consigneSecurite: 'Chaise stable. Garder le bassin stable et éviter de cambrer le dos pour compenser — l\'amplitude utile est petite, le mouvement vient de la hanche, pas du dos.',
    niveaux: {
      debutant: '8 répétitions par jambe, petite amplitude',
      intermediaire: '10 répétitions par jambe, sans cambrer le dos',
      avance: '12 répétitions par jambe avec lest à la cheville léger',
    },
    materielNecessaire: 'Chaise stable, lest de cheville en option',
    dureeEstimeeMinutes: 5,
    profilsCompatibles: ['prothese_hanche', 'diabete', 'obesite', 'tous'],
    adaptations: {
      prothese_hanche: 'Mouvement particulièrement adapté après prothèse (renforce le grand fessier) ; rester dans une amplitude modérée et indolore.',
      diabete: 'Vérifier que les chaussures offrent un bon maintien pendant cet exercice en appui unipodal partiel.',
      obesite: 'Privilégier un mouvement lent et de faible amplitude plutôt qu\'une grande amplitude compensée par le dos.',
    },
    positionRequise: 'debout',
    niveauMobilite: 'complet',
    reference: 'Programme Otago (Campbell & Robertson, University of Otago)',
    niveau_config: {
      "1": { series: 2, repetitions: 8,  duree_secondes: null, description: 'Petite amplitude, appui bilatéral', conseil: 'Le dos reste droit du début à la fin du mouvement' },
      "2": { series: 3, repetitions: 10, duree_secondes: null, description: 'Amplitude modérée sans cambrer le dos', conseil: 'Contractez légèrement les abdominaux pour stabiliser le bassin' },
      "3": { series: 3, repetitions: 12, duree_secondes: null, description: 'Avec lest de cheville léger', conseil: 'Réduisez l\'amplitude si vous sentez le bas du dos travailler' },
    },
  },
  {
    id: 'ot-mollets',
    nom: 'Montée sur pointes de pieds',
    categorie: 'force',
    description: 'Debout derrière une chaise, mains en appui léger, monter lentement sur la pointe des pieds puis redescendre les talons au sol sans les laisser retomber.',
    consigneSecurite: 'Chaise stable. Sol non glissant, chaussures fermées recommandées. Monter et descendre lentement, sans à-coup.',
    niveaux: {
      debutant: '8 répétitions, appui bilatéral franc sur la chaise',
      intermediaire: '12 répétitions, appui léger seulement',
      avance: '15 répétitions, un seul pied à la fois en alternance',
    },
    materielNecessaire: 'Chaise stable',
    dureeEstimeeMinutes: 4,
    profilsCompatibles: ['diabete', 'obesite', 'tous'],
    adaptations: {
      diabete: 'Vérifier l\'absence de plaie ou de point d\'appui douloureux sous le pied avant l\'exercice (neuropathie possible). Sol non glissant impératif.',
      obesite: 'Bien répartir l\'appui sur les deux pieds au début ; l\'amplitude peut être réduite sans perdre l\'efficacité du renforcement.',
    },
    positionRequise: 'debout',
    niveauMobilite: 'complet',
    reference: 'Programme Otago (Campbell & Robertson, University of Otago)',
    niveau_config: {
      "1": { series: 2, repetitions: 8,  duree_secondes: null, description: 'Appui bilatéral franc sur la chaise', conseil: 'Montez lentement, comptez jusqu\'à 2 en haut' },
      "2": { series: 3, repetitions: 12, duree_secondes: null, description: 'Appui léger, du bout des doigts', conseil: 'Cherchez l\'équilibre avant de réduire l\'appui si possible' },
      "3": { series: 3, repetitions: 15, duree_secondes: null, description: 'Un seul pied à la fois, en alternance', conseil: 'Gardez la cheville d\'appui souple, pas verrouillée' },
    },
  },

  // ÉQUILIBRE — Otago
  {
    id: 'ot-transfert-lateral',
    nom: 'Transferts de poids latéraux debout',
    categorie: 'equilibre',
    description: 'Debout, pieds écartés largeur de hanches, transférer lentement le poids du corps d\'un pied vers l\'autre, sans décoller les pieds du sol.',
    consigneSecurite: 'À proximité d\'un mur ou d\'une chaise en cas de besoin d\'appui. Mouvement lent, jamais brusque.',
    niveaux: {
      debutant: '10 transferts, près d\'un appui, amplitude réduite',
      intermediaire: '15 transferts sans appui, amplitude complète',
      avance: '15 transferts en tournant la tête de gauche à droite',
    },
    materielNecessaire: 'Aucun (chaise ou mur à proximité recommandé)',
    dureeEstimeeMinutes: 4,
    profilsCompatibles: ['diabete', 'obesite', 'parkinson', 'sep', 'tous'],
    adaptations: {
      diabete: 'Porter des chaussures fermées ; la perception du sol peut être diminuée en cas de neuropathie.',
      obesite: 'Élargir légèrement l\'écart des pieds si besoin, pour une base d\'appui plus stable.',
    },
    positionRequise: 'debout',
    niveauMobilite: 'complet',
    reference: 'Programme Otago (Campbell & Robertson, University of Otago)',
    niveau_config: {
      "1": { series: 2, repetitions: 10, duree_secondes: null, description: 'Près d\'un appui, amplitude réduite', conseil: 'Gardez un appui à portée de main' },
      "2": { series: 3, repetitions: 15, duree_secondes: null, description: 'Sans appui, amplitude complète', conseil: 'Regard fixé droit devant, pas vers le sol' },
      "3": { series: 3, repetitions: 15, duree_secondes: null, description: 'En tournant la tête de gauche à droite', conseil: 'Ralentissez si vous sentez un déséquilibre' },
    },
  },
  {
    id: 'ot-marche-tandem',
    nom: 'Marche talon-orteil (tandem walk)',
    categorie: 'equilibre',
    description: 'Marcher en ligne droite en posant le talon d\'un pied juste devant les orteils de l\'autre, comme sur une ligne.',
    consigneSecurite: 'Couloir dégagé, si possible le long d\'un mur pour un appui de sécurité. Chaussures à semelle plate.',
    niveaux: {
      debutant: '5 mètres, main longeant le mur',
      intermediaire: '10 mètres sans appui',
      avance: '10 mètres en tenant un objet dans les mains (double tâche)',
    },
    materielNecessaire: 'Couloir dégagé d\'au moins 3 mètres',
    dureeEstimeeMinutes: 5,
    profilsCompatibles: ['parkinson', 'sep', 'diabete', 'obesite', 'tous'],
    adaptations: {
      parkinson: 'Marquer chaque pas à voix haute ou compter peut aider à limiter le blocage de la marche (freezing) ; s\'arrêter complètement entre deux tentatives si besoin.',
      sep: 'Prévoir des pauses en cas de fatigue ; ne pas enchaîner plusieurs longueurs sans repos.',
      diabete: 'Vérifier l\'absence de gêne plantaire avant de commencer.',
    },
    positionRequise: 'debout',
    niveauMobilite: 'complet',
    reference: 'Programme Otago (Campbell & Robertson, University of Otago)',
    niveau_config: {
      "1": { series: 2, repetitions: null, duree_secondes: 10, description: '5 mètres, main longeant le mur', conseil: 'Regardez un point fixe devant vous, pas vos pieds' },
      "2": { series: 3, repetitions: null, duree_secondes: 20, description: '10 mètres sans appui', conseil: 'Faites une pause si vous perdez l\'équilibre, ne forcez pas' },
      "3": { series: 3, repetitions: null, duree_secondes: 25, description: '10 mètres en tenant un objet léger', conseil: 'Ralentissez le pas plutôt que d\'accélérer pour garder l\'équilibre' },
    },
  },
  {
    id: 'ot-tandem-statique',
    nom: 'Position tandem statique',
    categorie: 'equilibre',
    description: 'Debout, un pied directement devant l\'autre, talon contre orteils, maintenir la position le plus stable possible.',
    consigneSecurite: 'À proximité immédiate d\'un appui (chaise, mur). Ne jamais tenter sans appui à proximité en cas d\'antécédent de chute.',
    niveaux: {
      debutant: '10 secondes chaque côté, un doigt en appui sur une chaise',
      intermediaire: '20 secondes chaque côté, sans appui',
      avance: '30 secondes chaque côté, yeux fermés',
    },
    materielNecessaire: 'Chaise stable',
    dureeEstimeeMinutes: 4,
    profilsCompatibles: ['parkinson', 'sep', 'diabete', 'obesite', 'tous'],
    adaptations: {
      parkinson: 'Proposer un point de repère visuel fixe devant soi ; interrompre si une instabilité soudaine apparaît.',
      sep: 'Réduire la durée de maintien en cas de fatigue visuelle ou proprioceptive.',
      diabete: 'La perception de l\'appui plantaire peut être réduite ; privilégier la version avec appui si le pied est peu sensible.',
    },
    positionRequise: 'debout',
    niveauMobilite: 'complet',
    reference: 'Programme Otago (Campbell & Robertson, University of Otago)',
    niveau_config: {
      "1": { series: 2, repetitions: null, duree_secondes: 10, description: 'Un doigt en appui sur une chaise', conseil: 'Ne lâchez l\'appui que si vous vous sentez stable' },
      "2": { series: 3, repetitions: null, duree_secondes: 20, description: 'Sans appui', conseil: 'Regard fixe sur un point immobile devant vous' },
      "3": { series: 3, repetitions: null, duree_secondes: 30, description: 'Sans appui, yeux fermés', conseil: 'Appui disponible à portée de main en cas de besoin' },
    },
  },
  {
    id: 'ot-lever-chaise',
    nom: 'Lever de chaise sans les mains',
    categorie: 'equilibre',
    description: 'Se lever d\'une chaise sans prendre appui sur les accoudoirs ni sur les mains, puis se rasseoir lentement et avec contrôle.',
    consigneSecurite: 'Chaise stable, à hauteur d\'assise standard, idéalement contre un mur. Accoudoirs disponibles à proximité en cas de besoin ponctuel — l\'objectif est de s\'en passer, pas de risquer la chute.',
    niveaux: {
      debutant: '5 répétitions, appui léger des mains sur les cuisses autorisé',
      intermediaire: '8 répétitions, sans aucun appui des mains',
      avance: '10 répétitions, le plus rapidement possible en gardant le contrôle',
    },
    materielNecessaire: 'Chaise stable à assise standard',
    dureeEstimeeMinutes: 4,
    profilsCompatibles: ['prothese_genou', 'prothese_hanche', 'diabete', 'obesite', 'tous'],
    adaptations: {
      prothese_genou: 'Vérifier l\'amplitude de flexion autorisée avant de viser une chaise basse ; commencer avec une chaise plus haute si besoin.',
      prothese_hanche: 'Respecter les précautions posturales indiquées par le chirurgien (ne pas croiser les jambes, ne pas fléchir excessivement la hanche selon la voie d\'abord).',
      diabete: 'S\'assurer d\'un bon appui plantaire, chaussures fermées recommandées.',
      obesite: 'Une chaise plus haute au démarrage facilite l\'exercice sans en réduire le bénéfice fonctionnel.',
    },
    positionRequise: 'assis',
    niveauMobilite: 'complet',
    reference: 'Programme Otago (Campbell & Robertson, University of Otago)',
    niveau_config: {
      "1": { series: 2, repetitions: 5,  duree_secondes: null, description: 'Appui léger des mains sur les cuisses autorisé', conseil: 'Penchez le buste vers l\'avant avant de vous lever, pour transférer le poids' },
      "2": { series: 3, repetitions: 8,  duree_secondes: null, description: 'Sans appui des mains', conseil: 'Contrôlez la descente, ne vous laissez pas tomber sur l\'assise' },
      "3": { series: 3, repetitions: 10, duree_secondes: null, description: 'Le plus rapidement possible, en gardant le contrôle', conseil: 'La vitesse ne doit jamais se faire au détriment de la stabilité' },
    },
  },
  {
    id: 'ot-marche-arriere',
    nom: 'Marche arrière assistée',
    categorie: 'equilibre',
    description: 'Marcher quelques pas en arrière en ligne droite, avec appui ou supervision à proximité.',
    consigneSecurite: 'Toujours avec supervision ou à proximité immédiate d\'un appui (mur, meuble stable). Espace dégagé derrière soi, vérifié avant de commencer. Ne jamais pratiquer seul en cas d\'antécédent de chute non stabilisé.',
    niveaux: {
      debutant: '5 pas, supervision rapprochée, main longeant un mur',
      intermediaire: '8 pas, supervision à distance, sans appui',
      avance: '10 pas, en tournant la tête pour regarder par-dessus l\'épaule',
    },
    materielNecessaire: 'Espace dégagé d\'au moins 3 mètres, supervision recommandée',
    dureeEstimeeMinutes: 5,
    profilsCompatibles: ['parkinson', 'sep', 'diabete', 'obesite', 'tous'],
    adaptations: {
      parkinson: 'Exercice à réaliser uniquement en présence d\'un tiers, le blocage de la marche est plus fréquent en marche arrière ; s\'arrêter immédiatement en cas d\'hésitation du pas.',
      sep: 'Limiter la distance en cas de fatigue ou de trouble proprioceptif marqué ce jour-là.',
      diabete: 'Vérifier la sensibilité plantaire avant l\'exercice ; la marche arrière sollicite fortement la proprioception.',
      obesite: 'Privilégier des petits pas courts et contrôlés plutôt que des pas amples.',
    },
    positionRequise: 'debout',
    niveauMobilite: 'complet',
    reference: 'Programme Otago (Campbell & Robertson, University of Otago)',
