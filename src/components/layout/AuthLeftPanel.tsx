export default function AuthLeftPanel() {
  ...
  return (
    <div className="login-left" style={{
      ...
      {/* Cercles décoratifs */}
      <div style={{ position: 'absolute', top: -100, right: -100, width: 360, height: 360, borderRadius: '50%', border: '1.5px solid rgba(255,255,255,0.08)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', top: -40,  right: -40,  width: 200, height: 200, borderRadius: '50%', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: -80, right: 60,  width: 240, height: 240, borderRadius: '50%', border: '1px solid rgba(43,191,191,0.12)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: -30, left: -60,  width: 200, height: 200, borderRadius: '50%', background: 'rgba(43,191,191,0.05)', pointerEvents: 'none' }} />
