  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm">
        <label className="block text-xs font-medium text-gray-600 mb-2">Sélectionner un bénéficiaire</label>
        <select
          value={patientId}
        ...
        <>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
            <div className="px-4 py-3 border-b border-gray-100">
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                Zones vertes = disponibilités de {patient.prenom} · Gris = séances des autres bénéficiaires
              </p>
            </div>

            {joursDispos.length === 0 ? (
              <div className="p-6 text-sm text-gray-400 text-center">
                Aucune disponibilité renseignée pour ce bénéficiaire.
              </div>
            ) : (
              <div className="p-4">
                {/* Onglets jours */}
