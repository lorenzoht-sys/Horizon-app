...
-- NE PAS EXÉCUTER SUR PROD SANS VALIDATION PRÉALABLE — appliquée et
-- vérifiée par l'utilisateur en staging puis production, pas par cet agent
-- (connexion Postgres directe indisponible depuis cette machine). Voir
-- supabase/verifications/20260917_cours_collectifs.verif.sql.
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- 2. participations_cours_collectifs
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 3. Vérification immédiate — échoue bruyamment si la structure n'est pas
